...
function renderWire(
  ...
  if (paint.selection) strokes.push(renderStroke(routePath, paint.selection, 'routecore-wire-selection'));
  if (paint.warning) strokes.push(renderStroke(routePath, paint.warning, 'routecore-wire-warning'));
  if (paint.outline) strokes.push(renderStroke(routePath, paint.outline, 'routecore-wire-outline'));
  for (const layer of paint.engineeringLayers) strokes.push(renderStroke(routePath, layer, 'routecore-wire-stroke'));
